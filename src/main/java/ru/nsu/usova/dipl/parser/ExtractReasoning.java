...
public class ExtractReasoning {
    ...
    public ExtractReasoning() throws IOException {
        BufferedReader markersSrc = new BufferedReader(new FileReader("src/main/resources/reasoningTemplates.txt"));
        BufferedReader unionsSrc = new BufferedReader(new FileReader("src/main/resources/unions.txt"));
        BufferedReader signsSrc = new BufferedReader(new FileReader("src/main/resources/signs.txt"));
